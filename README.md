...
| **Figure IV**   | **Panel A (left to right)**: PK_time_series_train_vRep.pdf, PK_time_series_valid_vRep.pdf, PK_time_series_test_vRep.pdf. 
**Panel B (left to right)**: AJ_PK_time_series_train_vRep.pdf, AJ_PK_time_series_valid_vRep.pdf, AJ_PK_time_series_test_vRep.pdf |
| **Figure V**    |                                                       |
| **Figure VI**   |                                                       |
| **Figure VII**  |                                                       |
| **Figure VIII** |                                                       |
